...
This practical work report presents a systematic experimental evaluation of eight state-of-the-art Implicit Neural Representation (INR) methods for single-image super-resolution tasks. Building upon the comprehensive survey by Essakine et al.~\cite{essakine2024survey}, we implemented and compared SIREN, WIRE, GAUSS, FINER, Fourier Features, INCODE, MFN, and FR architectures across multiple upscaling factors ranging from 2$\times$ to 16$\times$. To obtain statistically robust results, each method-scale combination was evaluated under 10 independent random seeds; all reported metrics are empirical mean $\pm$ standard deviation. Our experiments on DIV2K~\cite{agustsson2017div2k} image \#0788 reveal significant performance variations. SIREN consistently achieves the highest reconstruction quality ($28.51 \pm 0.04$~dB PSNR at 2$\times$) and the smallest standard deviation across seeds, confirming robust reproducibility. In contrast, MFN experiences catastrophic failure at 8$\times$ and 16$\times$ scales ($15.05 \pm 0.50$~dB and $10.09 \pm 0.51$~dB respectively), indicating consistent architectural breakdown rather than a sharply initialization-dependent threshold. The complete implementation is publicly available on GitHub\footnote{\url{https://github.com/AhmedKElshahed/INR}}, providing reproducible baselines for future INR research in super-resolution applications.
...
Performance matrices for 32 method-scale combinations evaluated over 10 random seeds each: mean PSNR range 10.09--28.51~dB, mean SSIM range 0.20--0.81, mean LPIPS range 0.36--0.78. Standard deviations range from $<$0.05~dB for stable methods (SIREN, WIRE) to $\approx$0.5~dB for collapsing methods (MFN at high scales). Training times span 47--1133 seconds per run.

\vspace{0.3cm}
\textbf{7. What were the results of the analyses?} \\
SIREN proved most stable, maintaining $>$22~dB PSNR at 16$\times$ with very low seed-to-seed variance ($<0.05$~dB std). MFN failed catastrophically at 8$\times$ and beyond with moderate variance ($\pm 0.50$~dB), showing consistently poor convergence at high upscaling ratios. Computational costs varied by a factor of 32$\times$ across configurations.
...
& 2$\times$  & $\mathbf{28.51 \pm 0.04}$ & $\mathbf{0.808 \pm 0.002}$ & $\mathbf{0.357 \pm 0.003}$ & 859 \\
& 4$\times$  & $\mathbf{26.47 \pm 0.02}$ & $\mathbf{0.694 \pm 0.002}$ & $\mathbf{0.450 \pm 0.002}$ & 234 \\
& 8$\times$  & $\mathbf{24.48 \pm 0.01}$ & $\mathbf{0.564 \pm 0.001}$ & $\mathbf{0.594 \pm 0.002}$ & 83 \\
& 16$\times$ & $\mathbf{22.90 \pm 0.01}$ & $\mathbf{0.515 \pm 0.001}$ & $0.687 \pm 0.001$ & 47 \\
\midrule
\multirow{4}{*}{FR}
& 2$\times$  & $24.75 \pm 0.05$ & $0.571 \pm 0.002$ & $0.595 \pm 0.003$ & 854 \\
& 4$\times$  & $24.16 \pm 0.04$ & $0.544 \pm 0.001$ & $0.649 \pm 0.003$ & 235 \\
& 8$\times$  & $23.07 \pm 0.05$ & $0.514 \pm 0.001$ & $0.689 \pm 0.002$ & 84 \\
& 16$\times$ & $21.66 \pm 0.13$ & $0.486 \pm 0.003$ & $0.697 \pm 0.005$ & 47 \\
\midrule
\multirow{4}{*}{WIRE}
& 2$\times$  & $26.73 \pm 0.06$ & $0.694 \pm 0.004$ & $0.497 \pm 0.004$ & 1133 \\
& 4$\times$  & $24.76 \pm 0.04$ & $0.568 \pm 0.002$ & $0.621 \pm 0.003$ & 302 \\
& 8$\times$  & $23.49 \pm 0.02$ & $0.526 \pm 0.001$ & $0.644 \pm 0.001$ & 104 \\
& 16$\times$ & $22.03 \pm 0.05$ & $0.497 \pm 0.001$ & $0.634 \pm 0.001$ & 56 \\
\midrule
\multirow{4}{*}{FINER}
& 2$\times$  & $23.72 \pm 0.03$ & $0.531 \pm 0.001$ & $0.652 \pm 0.002$ & 874 \\
& 4$\times$  & $22.38 \pm 0.07$ & $0.505 \pm 0.001$ & $0.634 \pm 0.001$ & 238 \\
& 8$\times$  & $21.04 \pm 0.08$ & $0.480 \pm 0.002$ & $0.628 \pm 0.000$ & 85 \\
& 16$\times$ & $20.10 \pm 0.08$ & $0.466 \pm 0.001$ & $\mathbf{0.629 \pm 0.001}$ & 47 \\
\midrule
\multirow{4}{*}{MFN}
& 2$\times$  & $26.34 \pm 0.05$ & $0.686 \pm 0.003$ & $0.500 \pm 0.002$ & 897 \\
& 4$\times$  & $24.48 \pm 0.09$ & $0.549 \pm 0.007$ & $0.560 \pm 0.003$ & 244 \\
& 8$\times$  & $15.05 \pm 0.50$ & $0.285 \pm 0.017$ & $0.753 \pm 0.046$ & 87 \\
& 16$\times$ & $10.09 \pm 0.51$ & $0.196 \pm 0.058$ & $0.775 \pm 0.070$ & 47 \\
\midrule
\multirow{4}{*}{INCODE}
& 2$\times$  & $25.03 \pm 0.24$ & $0.584 \pm 0.014$ & $0.593 \pm 0.021$ & 957 \\
& 4$\times$  & $24.36 \pm 0.16$ & $0.551 \pm 0.006$ & $0.648 \pm 0.008$ & 261 \\
& 8$\times$  & $22.92 \pm 0.39$ & $0.513 \pm 0.008$ & $0.652 \pm 0.010$ & 91 \\
& 16$\times$ & $17.94 \pm 0.54$ & $0.441 \pm 0.008$ & $0.630 \pm 0.001$ & 50 \\
\midrule
\multirow{4}{*}{GAUSS}
& 2$\times$  & $25.55 \pm 0.09$ & $0.616 \pm 0.006$ & $0.547 \pm 0.007$ & 882 \\
& 4$\times$  & $23.16 \pm 0.25$ & $0.520 \pm 0.005$ & $0.646 \pm 0.007$ & 241 \\
& 8$\times$  & $20.78 \pm 0.11$ & $0.480 \pm 0.002$ & $0.629 \pm 0.001$ & 86 \\
& 16$\times$ & $17.43 \pm 0.28$ & $0.420 \pm 0.009$ & $0.636 \pm 0.002$ & 48 \\
\midrule
\multirow{4}{*}{Fourier}
& 2$\times$  & $26.80 \pm 0.05$ & $0.701 \pm 0.004$ & $0.456 \pm 0.003$ & 847 \\
& 4$\times$  & $25.60 \pm 0.04$ & $0.615 \pm 0.003$ & $0.519 \pm 0.003$ & 233 \\
& 8$\times$  & $23.84 \pm 0.04$ & $0.512 \pm 0.003$ & $0.601 \pm 0.003$ & 84 \\
& 16$\times$ & $20.52 \pm 0.18$ & $0.391 \pm 0.008$ & $0.662 \pm 0.003$ & 48 \\
\bottomrule
\end{tabular}
\end{table}

Key patterns include SIREN's consistent lead (0.6--1.7~dB) across all scales and very low standard deviations ($<0.05$~dB), confirming robust reproducibility. MFN's collapse at 8$\times$ is severe (9.43~dB drop from 4$\times$) with moderate variance ($\pm 0.50$~dB), indicating consistently poor but unstable convergence rather than a sharply initialization-dependent threshold. Training times span 47~s (MFN, 16$\times$) to 1133~s (WIRE, 2$\times$).
...
\midrule
SIREN & 2.04 & 1.99 & 1.58 & 1.87 & Linear \\
WIRE & 1.97 & 1.27 & 1.46 & 1.57 & Linear \\
FINER & 1.34 & 1.34 & 0.94 & 1.21 & Linear \\
FR & 0.59 & 1.09 & 1.41 & 1.03 & Accelerating \\
Fourier & 1.20 & 1.76 & 3.32 & 2.09 & Step \\
GAUSS & 2.39 & 2.38 & 3.35 & 2.71 & Accelerating \\
INCODE & 0.67 & 1.44 & 4.98 & 2.36 & Step \\
MFN & 1.86 & 9.43 & 4.96 & 5.42 & Catastrophic \\
\bottomrule
\end{tabular}
\end{table}

The degradation patterns fall into four distinct classes. Methods with \textit{linear} degradation (SIREN, WIRE, FINER) show consistent approximately 1.2--1.9 dB drops per doubling, making their behavior predictable across scales. FINER is notably the most stable, losing only 0.94 dB from 8$\times$ to 16$\times$. \textit{Accelerating} degradation in GAUSS and FR indicates these methods approach their representational limits as scale increases. \textit{Step-function} degradation in Fourier Features and INCODE manifests as sudden collapse at specific thresholds: Fourier drops 3.32 dB at 8$\times$$\to$16$\times$, and INCODE collapses 4.98 dB at the same transition. Most dramatically, MFN exhibits \textit{catastrophic} degradation with a 9.43 dB drop from 4$\times$ to 8$\times$, representing complete architectural breakdown.
...
\midrule
Best & Fourier (847/26.8) & SIREN (234/26.5) & SIREN (83/24.5) & SIREN (47/22.9) \\
Good & SIREN (859/28.5) & Fourier (233/25.6) & Fourier (84/23.8) & WIRE (56/22.0) \\
Moderate & FINER (874/23.7) & FINER (238/22.4) & FINER (85/21.0) & Fourier (48/20.5) \\
Poor & WIRE (1133/26.7) & WIRE (302/24.8) & WIRE (104/23.5) & FINER (47/20.1) \\
\bottomrule
\end{tabular}
\end{table}
...
The results demonstrate that periodic activations are essential for multi-scale robustness. SIREN's consistent leadership across all upscaling factors, declining gracefully from 28.51 dB at 2$\times$ to 22.90 dB at 16$\times$, shows that sinusoidal activations provide inherent multi-scale frequency representation. The carefully tuned frequency parameters ($\omega_0^{\text{first}} = 80$, $\omega_0^{\text{hidden}} = 30$) discovered through grid search prove sufficient for scales up to 16$\times$ without requiring architectural modifications.

Conversely, multiplicative architectures prove fundamentally unsuitable for this task. MFN's catastrophic failure, with a 9.43 dB drop between 4$\times$ and 8$\times$ resulting in just 10.09 dB at 16$\times$, represents complete architectural breakdown rather than gradual degradation. The moderate standard deviation ($\pm 0.50$~dB at 8$\times$) indicates that this collapse is consistent across initializations, not an edge case. The multiplicative structure creates pathological interactions at high downsampling ratios, definitively showing that multiplicative filter networks cannot handle high-ratio super-resolution.
...
For high-ratio super-resolution at 8$\times$ to 16$\times$ scales, SIREN and WIRE are the only methods maintaining greater than 22 dB PSNR at both scales (22.90 and 22.03 dB respectively at 16$\times$). SIREN remains the top recommendation due to its lower computational cost than WIRE. MFN should never be used due to complete failure, and INCODE, GAUSS, and Fourier Features should be avoided due to severe degradation at these scales.
